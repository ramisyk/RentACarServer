    ...
    IMailService mailService) : IRequestHandler<ForgotPasswordCommand, Result<string>>
{
    public async Task<Result<string>> Handle(ForgotPasswordCommand request, CancellationToken cancellationToken)
    {
        ...
        if (user == null)
        {
            return Result<string>.Failure("User with the provided email does not exist.");
        }
        ...
        //string body = $"Dear {user.FullName.Value},\n\n" +
        //              "We received a request to reset your password. Please use the following link to reset your password:\n\n" +
        //              $"https://yourapp.com/reset-password?token={user.ForgotPasswordId?.Value}\n\n" +
...
<body>
    ...
    <table role=""presentation"" cellspacing=""0"" cellpadding=""0"" border=""0"" width=""100%"" style=""background-color: #f9f9f9;"">
        ...
        // todo: Implement password reset token generation and email sending logic here.
